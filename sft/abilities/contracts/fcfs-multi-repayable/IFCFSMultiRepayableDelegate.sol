...
interface IFCFSMultiRepayableDelegate {
    ...
    event Refund(uint256 indexed slot, address currency, uint256 refundCurrencyAmount);
    ...
    function refundOnlyOwner(uint256 slot_, address currency_) external returns (uint256);
}